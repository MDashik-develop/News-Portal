...
//     /**
//      * First line: ঢাকা, বৃহস্পতিবার ১০ জুন ২০২১
//      */
...
//     /**
//      * Second line: ২৬ জ্যৈষ্ঠ ১৪২৮, ১৩ জিলকদ ১৪৪২
//      */
//     public static function formattedLineTwo(?Carbon $date = null): string
//     {
//         $date = $date ?? Carbon::now('Asia/Dhaka');

//         // Approximate Bangla month and year
//         $banglaMonths = [
//             'বৈশাখ', 'জ্যৈষ্ঠ', 'আষাঢ়', 'শ্রাবণ', 'ভাদ্র', 'আশ্বিন',
//             'কার্তিক', 'অগ্রহায়ণ', 'পৌষ', 'মাঘ', 'ফাল্গুন', 'চৈত্র',
//         ];
//         $monthIndex = ((int) $date->format('m') + 8) % 12;
//         $banglaMonth = $banglaMonths[$monthIndex];
//         $banglaDay = self::convertToBanglaNumber($date->day);
//         $banglaYear = self::convertToBanglaNumber((string) ($date->year - 593)); // crude approximation

//         // Hijri date using IntlDateFormatter
...
//         $hijriDate = $intl->format($timestamp); // Example: ১৩ জিলকদ ১৪৪২

//         return "{$banglaDay} {$banglaMonth} {$banglaYear}, {$hijriDate}";
//     }
// }
